...
class ACPSuccesCardViewController: UIViewController {
    ...
    private let titleLabel: UILabel = {
        let label = UILabel()
        label.text = .localizedString(key: "successfull_card_title")
    ...
    private lazy var subtitleLabel: UILabel = {
        let label = UILabel()
        label.text = .localizedString(key: "acp_successfull_card_desc")
        label.textAlignment = .center
        label.translatesAutoresizingMaskIntoConstraints = false
